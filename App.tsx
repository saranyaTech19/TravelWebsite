      ...
      <div className="min-h-screen bg-brand-bg relative w-full overflow-x-hidden">
        ...
        {location.pathname !== '/admin' && (
          <a
            ...
            className="fixed bottom-28 right-8 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 z-50 hover:-translate-y-2"
