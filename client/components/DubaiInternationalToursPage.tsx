...
interface DubaiInternationalToursPageProps {
  onExplore: (tour: any) => void;
  onBookClick: () => void;
}

const DubaiInternationalToursPage: React.FC<DubaiInternationalToursPageProps> = ({ onExplore, onBookClick }) => {
...
export default DubaiInternationalToursPage;
